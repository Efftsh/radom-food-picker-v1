...
function blockNumberAndPunctuation(str) {
  const value = str.replace(/[\p{N}\p{P}]/gu, "");
  return value;
}
input.addEventListener("input", function () {
  input.value = blockNumberAndPunctuation(input.value);
});
...
console.log(blockNumberAndPunctuation("123ajdaada:}{{"));
